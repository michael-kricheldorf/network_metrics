...
#define NOVATELWIRELESS_PRODUCT_DEBUG_U730L 0x9031
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE_AND_INTERFACE_INFO(NOVATELWIRELESS_VENDOR_ID, NOVATELWIRELESS_PRODUCT_DEBUG_U730L, 0xff, 0x0, 0x0)},
